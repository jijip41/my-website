...
// Click event
// When menu clicked, the menu will be underlined 
...
typing(); // typing function excecuted when the website loaded
...
// arrows eventlistener on the video carousel
...
// click event - will get text when clicked

// grab each of 4 images & text container
...
const seoul = `I was born and raised in South Korea. <br>
I was a teacher in my home city of Incheon. While teaching I met my future husband who was working as the only foreign teacher in the school. As he sometimes struggled to understand Korean curture and couldn't find ingredients at the supermarket, I helped him a lot and we became close. <br>
...
When I arrived in England, I began to work as a florist, creating floral arrangements for individuals and events. <br>
...
// click event - when clicked an image, it will get text accordingly and each image's opacity will be changed to 100%
...
// grab section's body, a tag on the menu
// get size of section body to place flowers
...
// will load 7 flowers when the page is loaded, not on a mobile
// when each flower is clicked it disapears and create paragraph
...
// function loading flowers
function loadFlowers() {
  start('flower', 7, 'media/flower.png');
}

// function creating each flower on a random position
...
// function getting random number to decide where to put flowers
function getRandomNum(min, max){
  return Math.floor(Math.random() * (max - min + 1) + min);
}

//function creating content for the paragraph which is created when flower's clicked
...
// each requirement's button event
...
// timeout executed when click each requirement button
...
// mobile respoinsive - will have buttons to lead an user to each website
